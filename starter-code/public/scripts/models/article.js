...
(function(module) {
  ...
  //this function is loading all rows into articles  which is making a new element in Article whih has the new  published on  Date.
  ...
  // DONE: What is this function doing? Where is it called? Does it call any other functions, and if so, in what file(s) do those function(s) live?
  //this is doing a ajax call to Delete
